...
# 変換対象のフォルダ
audio_input_folder = "audio"  # 元の音源フォルダ
sound_effects_input_folder = "sound_effects" # 元の音源フォルダ
...
sound_effects_input_folder = os.path.join(script_dir, "sound_effects")

# バイナリ保存先フォルダ
audio_output_folder = os.path.join(script_dir, "binary_audio")
sound_effects_output_folder = os.path.join(script_dir, "binary_sound_effects")

# 実行
convert_to_binary(audio_input_folder, audio_output_folder)
convert_to_binary(sound_effects_input_folder, sound_effects_output_folder)
